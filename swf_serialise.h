...
void swf_add_setbgcol(swf_movie * movie, int * error, swf_colour * bgcol);
...
extern void swf_serialise_definebutton (swf_buffer * buffer, int * error, swf_definebutton * button);
